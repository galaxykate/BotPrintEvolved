...
define(["ui", "./bot/tuning", "./bot/bot", "./botCard", "./physics/arena", "threeUtils", "./botEvo", "app", "common", "./population", "./scoreGraph", "./heuristic", "./bot/attachment/attachments", "./UIArena"], function(UI, Tuning, Bot, BotCard, Arena, threeUtils, BotEvo, App, common, Population, ScoreGraph, Heuristic, Attachment, UIArena) {
