...
define(["three", "inheritance", "box2D"], function(THREE, Inheritance, Box2D) {
    ...
    Vector = Class.extend({
        ...
        isValid : function() {
            ...
            return (!isNaN(this.x) && !isNaN(this.y) && !isNaN(this.z) ) && this.x !== undefined && this.y !== undefined && this.z !== undefined && Math.abs(this.x) !== Infinity && Math.abs(this.y) !== Infinity && Math.abs(this.z) !== Infinity;
        },
        ...
        drawArrow : function(g, v, m, width, arrowSize, arrowOffset) {

            arrowOffset = arrowOffset ? arrowOffset : 0;
            var x = v.magnitude() * m;
            ...
            if (x > 0) {
                ...
                g.rotate(v.getAngle());
                g.noStroke();
                g.rect(0, -width / 2, x - arrowOffset, width);
                g.translate(x, 0);
                var w = arrowSize * .36;

                g.beginShape();
                g.vertex(arrowOffset, 0);
                g.vertex(-arrowSize - arrowOffset, w);
                g.vertex(-arrowSize * .8 - arrowOffset, 0);
                g.vertex(-arrowSize - arrowOffset, -w);
                g.endShape();
                g.popMatrix();
            }
