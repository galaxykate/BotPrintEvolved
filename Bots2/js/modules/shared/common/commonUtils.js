...
define('common', ["inheritance", prefix + "time", "noise", prefix + "transform", prefix + "vector", prefix + "tree", prefix + "rect", prefix + "map", prefix + "kcolor", prefix + "timespan", prefix + "utilities", prefix + "range", "jQueryUI", "underscore"], function(Inheritance, _Time, _Noise, _Transform, _Vector, _Tree, _Rect, _Map, _KColor, _TimeSpan, _utilities, _Range, JQUERY, _) {
    var common = {
        Vector : _Vector,
        Tree : _Tree,
        KColor : _KColor,
